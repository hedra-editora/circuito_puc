...
\linhalayout{conselho editorial}{\tiny \hspace*{-1pt}\, Ana Paula Kiffer (\versal{PUC-RJ}),\\
\qquad \qquad \qquad \qquad \quad \, Claudio Oliveira (\versal{UFF}),\\
\qquad \qquad \qquad \qquad \quad \, Eduardo Guerreiro B. Losso (\versal{UFRJ}),\\
...
O evento que deu origem ao presente livro foi patrocinado pelo\\
\versal{IEAH}u, Instituto de Estudos Avançados em Humanidades da \versal{PUC}-Rio. 
