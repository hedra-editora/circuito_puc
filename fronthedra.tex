...
Reis da Silva Mello, Luiz Roberto Cunha e Sergio Bruni\\
...
\linhalayout{conselho editorial}{\tiny \hspace*{-1pt}\, Ana Paula Kiffer (\versal{PUC-RIO}),\\
...
\vspace*{0cm}
\hspace*{-.2cm}\includegraphics[width=6cm]{./imgs/ficha.pdf}
\end{textblock*}
