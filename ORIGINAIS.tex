...
sentidos uma anti ou outra banda, a intenção original de que a canção fosse %é isso mesmo?
...
Na execução de ``Panis et circencis'', por outro lado, o arranjo de
...
motivos repetidos e percussivos. Algo da tradição operística verista, reduzida cameristicamente, aparece aqui no tratamento de temas proletários, em contraposição ao canto compacto de Caetano. Na execução original, o acompanhamento é
