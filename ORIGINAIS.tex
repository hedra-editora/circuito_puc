...
Virar jaguar\footnote{\textless{}\emph{https://bit.ly/36gz7iJ}\textgreater{}.}
\end{verse}
...
mesmo tempo, não perder a sua alma iorubá, selvagem, índia?''\footnote{\textless{}\emph{https://bit.ly/36L5fLp}\textgreater{}.}
...
autobiográficos:\footnote{Celso Furtado. \emph{A Fantasia Organizada}. In:
...
Raúl Prebisch mal elas foram publicadas, em 1950.\footnote{Raúl Prebisch.
  ``Interpretação do processo de desenvolvimento econômico''. In:
...
In: \emph{The Politics of Truth}. \emph{Selected
  Writings of C. Wright Mills}. Ed. John Summers. Oxford: Oxford University Press, 2008.}
...
interesse cada vez mais geral.\footnote{\emph{Cultura Posta em
...
era a primeira vez que eu o ouvia.\footnote{Caetano Veloso.
  ...
  pudera chegar do que me foi sugerido por \emph{Terra em Transe}'' (\emph{Ibidem}, p.~187). Vale lembrar que o filme de Glauber também é de 1967.}
\end{quote}
...
Sérgio Ferro e Waldemar Cordeiro (``realidade"-imagem'').\footnote{Celso Favaretto.
  ...
  labirinto}; Mario Schemberg. ``Um Novo Realismo''. In: Dayse Peccinini.
  \emph{Objeto na Arte: Brasil anos 60}. São Paulo: \versal{FAAP}, 1978; Waldemar
  Cordeiro. ``Realismo: musa da vingança e da tristeza''. In: Dayse
...
transformação, etc.''\footnote{Hélio Oiticica. ``Esquema Geral da Nova
  Objetividade''. In: \emph{Aspiro ao grande labirinto}, p.~94.} Na
...
ADVERSIDADE VIVEMOS!}\footnote{Idem. ``Esquema Geral da Nova
  Objetividade''. In: \emph{Aspiro ao grande labirinto}, p.~98.}
\end{quote}
...
indivíduo.\footnote{Idem. ``Aparecimento do supra"-sensorial na arte
  brasileira''. In: \emph{Aspiro ao grande labirinto}, p.~103.}
\end{quote}
...
tornado dança''.\footnote{Idem, carta a Torquato. In: Torquato Neto.
...
família'', mas que só funcionam para uma pequena minoria.\footnote{Ibidem, p.~81-2.}
\end{quote}
...
completação {[}sic{]} e razão de ser da vida.''\footnote{Ibidem,
  p.~83. Grifos do autor.} A vitalidade criativa, individual e
...
esperança''.\footnote{Herbert Marcuse. ``Preface'', \emph{An Essay on Liberation},
...
livres para interrompe"-los e prevenir seu recomeço.\footnote{Ibidem,
...
própria sociedade.\footnote{Herbert Marcuse. ``Preface'', \emph{An Essay on
  Liberation}, p.~25.}
\end{quote}
...
ensaio.\footnote{Herbert Marcuse. ``Preface'', \emph{An Essay on Liberation}, p.~x.}
\end{quote}
...
gêneros pregressos, essa ``identidade dinâmica''.\footnote{Bernardo
  Oliveira usa essa expressão no texto ``Rastros dos Trópcos'', sobre a
...
entre um narrador \emph{on} ou \emph{off}.\footnote{\emph{Narrador off} é
  ...
  faz a narração de dentro da cena mesmo, na diegese do filme.}
...
\chapter*{Brasil por multiplicação\footnote{Este título faz referência a
  ...
  subtração}, publicado em 1986 no livro \emph{Que horas são?} (São Paulo: Cia das
...
transformadores, nos planos ético"-político"-social''.\footnote{Hélio Oiticica.
  ``Esquema Geral da Nova Objetividade'', neste catálogo.}
...
antropofagia por meio de um \emph{glissando}.\footnote{Sobre o modo como
  ...
  filosofia e utopia: o espaço da antropofagia''. In: \emph{O que nos faz
    pensar}, n.~38, org. Pedro Durte, junho 2016, Rio de Janeiro"-\versal{PUC}.}
...
latino"-americanos.\footnote{Entre os trabalhos mais influentes sobre
  ...
  ensaio de interpretação sociológica.} Rio de Janeiro: Zahar Editora, 1970.}
...
uma cultura determinada''.\footnote{Ferreira Gullar, op. cit., p. 95.}
...
nela''.\footnote{Paulo Emílio Sales Gomes. ``Cinema: trajetória no
  subdesenvolvimento''. In: Paulo Emilio Sales Gomes. \emph{Cinema:
...
fato estrangeiro para o brasileiro, pois tudo já o é.\footnote{Paulo Emílio Sales Gomes, op. cit., p. 89-90.} Nesse contexto, o
...
edição e direção do cinema mundialmente hegemônico da época.\footnote{Paulo Emílio Sales Gomes, op. cit., p.~99-104.}
...
ou em outras áreas.\footnote{Glauber Rocha. ``Eztetyka da fome''. In:
  Glauber Rocha. \emph{Revolução do Cinema Novo}. São Paulo: Cosac
...
mesmos.\footnote{Glauber Rocha. ``O Cinema Novo e a aventura da
  criação''. In: Glauber Rocha, op. cit., p. 132 (texto
...
triste que alegre é o carnaval''.\footnote{Glauber Rocha. ``O Cinema
  Novo e a aventura da criação''. In: Glauber Rocha, op. cit., p. 133.}
...
comer.\footnote{Glauber Rocha. ``Eztetyka da fome''. In: Glauber Rocha,
op. cit., p. 63-67.}
...
necessária à sua sobrevivência.\footnote{Josué de Castro, op. cit., p. 34.}
...
colonizado''.\footnote{Glauber Rocha. ``Eztetyka da fome''. In: Glauber Rocha,
  op. cit., p. 66.} Somente através de uma estética da
...
Rocha: ``da adversidade vivemos!''.\footnote{Hélio Oiticica. ``Esquema
  geral da Nova Objetividade''. In: César Oiticica Filho (org.).
...
e sociais, principalmente após o golpe de 1964.\footnote{Hélio Oiticica.
  ``Esquema geral da Nova Objetividade''. In: César Oiticica Filho (org.),
  op. cit., p. 88.}
...
lugar, a noção de ``ambiente''.\footnote{Hélio Oiticica. ``Anotações
  sobre o parangolé''. In: César Oiticica Filho (org.), op. cit., p. 82.}
...
sentia ao caminhar por entre as vielas dos morros e favelas.\footnote{``Quando
  ...
  Hélio Oiticica para Ivan Cardoso, janeiro de 1979''. In: César Oiticica
  Filho; Sérgio Cohn; Ingrid Vieira (org.). \emph{Hélio
  Oiticica. Coleção Encontros}. Rio de Janeiro: Editora Azougue, 2009. p. 231.}
...
uma sensação vivida e apresentá"-la simbolicamente ao outro.\footnote{``Entrevista
  a Guy Brett. Londres, fevereiro de 1969''. César Oiticica Filho;
  Cohn, Sérgio Cohn; Ingrid Vieira (org.), op. cit., p. 60.} Anos
...
consciente do cotidiano.\footnote{Hélio Oiticica. ``Anotações sobre o
  parangolé''. In: César Oiticica Filho (org.), op. cit., p. 75.}
...
ultramoderno''.\footnote{Roberto Schwarz, op. cit., p. 24.}
...
finalmente a registrou em disco.\footnote{Caetano Veloso, op.~cit., p.~188.}
...
originais e que se querem emancipadores.\footnote{Glauber Rocha.
  ``Tropicalismo, antropologia, mito, ideograma''. In: Glauber Rocha,
...
entre ``simpatia e desgosto'' sobre a condição do Brasil,\footnote{Roberto Schwarz,
op. cit., p. 26.} colocando"-se em antítese ao slogan
...
``o sub desenvolvido embaixo da terra como rato de si mesmo'',\footnote{Hélio Oiticica.
  ``Subterrânia''. In: César Oiticica Filho (org.), op.
...
ainda.\footnote{Hélio Oiticica. ``Brasil diarreia''. In: César Oiticica Filho (org.),
op. cit., p. 163.}
...
merda'' para construir outra possibilidade de Brasil.\footnote{Hélio Oiticica.
  ``Brasil diarreia''. In: César Oiticica Filho (org.), op.
...
lúdica''.\footnote{Cf. \emph{Veneno Remédio: o Futebol e o Brasil}. São Paulo:
...
Chateaubriand\footnote{Chateaubriand começou a pensar em fazer televisão
  ...
  América Latina. Walter Clark et al. \emph{\versal{TV} ao vivo. Depoimentos}. São Paulo: Brasiliense, 1988.} colocou ``a coisa'' no ar, em
...
um ponto de vista de direita''.\footnote{Glauber Rocha.``Cinema
  Verdade''. In: \emph{A Revolução do Cinema Novo}. São Paulo: Cosac Naify,
  2004, p.~75-6.}
\end{quote}
...
de alienação da cultura contemporânea''.\footnote{Glauber Rocha. ``O
  Cinema Novo e a Aventura da Criação'', op.~cit., p.~132.} {[}``O cinema
...
média.''\footnote{Ibid. É interessante observar que a falta de
  ...
  Rio de Janeiro: Nova Fronteira, 1994, p.~451-3.}
\end{quote}
...
óbvio}''.\footnote{Glauber Rocha. ``O Padre e a Moça'', op. cit., p.~79
  (grifo no original).} Na contramão do revisionismo posterior que
...
objetivo, desestetizante, e estético na medida em que ético.\footnote{Glauber
  Rocha. ``Cinema Verdade'', p.~cit., p~75.}
\end{quote}
...
Brecht''.\footnote{Glauber Rocha. ``\emph{Filmcrítica}'', op. cit., p~300.}
...
simples''.\footnote{Ibid., p.~299.} Mas, em seguida, chega"-se ``à liberdade
...
justamente, que possamos falar em um ``meta"-realismo''.\footnote{Em uma
  ...
  reformismo''. Glauber Rocha. ``Entrevista Portuguesa'', op. cit., p.~271.
  ...
  ``Tropicalismo, Antropologia, Mito, Ideograma'', op. cit., p.~152.}
...
sociedade como um todo.\footnote{Um claro limite da
  ...
  Jalusa Barcellos, op. cit., p.~90 (grifo no original).}
...
Latino"-Americano''.\footnote{Tratam"-se, na verdade, de segmentos de um
  ...
  Clandestina: Teorias de Cinema na América Latina}. São Paulo: 34/\versal{EDUSP}, 1995, p.~111, n. 44. Este texto, escrito em 1967 --- um excerto
...
``tradição estética e econômica para o futuro''\footnote{Glauber Rocha.
  ``O Transe da América Latina'', op. cit., p.~186.} a partir do esforço
...
direto,\footnote{Glauber Rocha. \emph{Cahiers du Cinéma}, op. cit.,
  p.~213.} o método de trabalho e o estilo de Glauber mudam
...
representação}.\footnote{Ibid., p.~210 (gifo do autor).}
\end{quote}
...
espírito em 1969.\footnote{Ibid., p.~218 (grifo do autor).}
\end{quote}
...
liberador'' como ``a mais forte arte arma do revolucionário''.\footnote{Glauber
  Rocha. ``Eztetyka do Sonho'', op.~cit., p.~250.}
...
intensificar o consumo de massa.\footnote{Mário Pedrosa. \emph{Dos
  Murais de Portinari aos Espaços de Brasília}. São Paulo: Ed. Perspectiva, p. 217-221.}
\end{quote}
...
hambúrguer, e daí?''.\footnote{Antonio Dias. ``Entrevista de Antonio Dias e Rubens Gerchman
  a Ferreira Gullar''. In: Ferreira Gullar, Antonio
  Dias e Rubens Gerchman, \emph{Revista Civilização Brasileira}, n.~11-12,
...
pela orgia da mercadoria''.\footnote{Sérgio Ferro, op.~cit.}
...
hormônios, com seus cheiros e suas cores.\footnote{Mário Pedrosa, op.~cit.}
\end{quote}
...
tentativa de ``conquista da América''.\footnote{Sobre a investida de
  ...
  \versal{MA}: Museo Nacional Reina Sofia e \versal{MIT} Press, p.~53-62.} Este fracasso
...
Hiroshima''.\footnote{Hélio Oiticica. ``Vivência do Morro do Quieto''.
  ...
  Basualdo. São Paulo: Cosac Naify, 2007, p.~218-219.} Em outras palavras,
