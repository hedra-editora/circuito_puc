...
\begin{flushright}
\emph{João Camillo Penna} (\versal{UFRJ})
\end{flushright}
...
Virar jaguar\footnote{https://bit.ly/36gz7iJ}
\end{verse}
...
Para você -- sou eu que te seguro os ombros e grito \qb{}verdades nos
...
\begin{flushright}
\emph{Flávia Cêra}\footnote{Doutora em Literatura pela Universidade Federal de
...
\addcontentsline{toc}{chapter}{Balanços da fossa: o caso da \emph{Revista Civilização Brasileira},\break \emph{por Fred Coelho}}
...
\addcontentsline{toc}{chapter}{Aqui É O Fim Do Mundo: Candeias, Coni Campos,~1967,\break \emph{por Juliano Gomes}}
...
\begin{flushright}
\emph{Luiz Camillo Osorio}\footnote{Professor na \versal{PUC}-Rio, pesquisador
...
\begin{flushright}
\emph{Marília Rothier Cardoso}\footnote{Departamento de Letras, \versal{PUC}-Rio}
\end{flushright}
...
\addcontentsline{toc}{chapter}{Eles sabem o dia de amanhã, mas eu quero seguir vivendo,\break \emph{por Pedro Duarte}}
...
\addcontentsline{toc}{chapter}{Realismo, Anti-Realismo e Meta-Realismo em Glauber Rocha,\break \emph{por Rodrigo Nunes}}
...
\addcontentsline{toc}{chapter}{``Popau Brasil'': Pop, realismo e subdesenvolvimento em 1967,\break \emph{por Sérgio Bruno Martins}}
