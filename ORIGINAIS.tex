...
tropicalismo hoje)\footnote{Este texto é uma parte de um ensaio maior,
  ...
  organizadores de cada evento: Fred Coelho e Felipe Escovino (\versal{PUC"-RJ},
...
\begin{flushright}
João Camillo Penna (\versal{UFRJ})
\end{flushright}
...
autobiográficos\footnote{\versal{FURTADO}, C. \emph{A Fantasia Organizada. In}:
...
Raúl Prebisch mal elas foram publicadas, em 1950\footnote{\versal{PREBISCH}, R.
...
subdesenvolvidos\footnote{\versal{WRIGHT} \versal{MILLS}, C. ``The Cultural Apparatus''.
  \emph{In}: \versal{SUMMERS}, J. H. \emph{The Politics of Truth}. \emph{Selected
...
(1980)\footnote{\versal{FURTADO}, C. \emph{Pequena Introdução ao Desenvolvimento:
...
anos de industrialização, é ``um impasse''\footnote{\versal{FURTADO}, C. ``Que
...
população''\footnote{\versal{FURTADO}, C. ``O Verdadeiro Desenvolvimento''.
...
Favaretto\footnote{\versal{FAVARETTO}, C. \emph{Tropicália: Alegria, Alegoria}.
  São Paulo: Ateliê Editorial, 1996.} e ``susto'' por Heloísa
Buarque\footnote{\versal{BUARQUE DE HOLLANDA}, H. \emph{Impressões de
...
subdesenvolvimento\footnote{\versal{ACUIO}, C. ``Por que canta Caetano Veloso'',
  revista \emph{Manchete}, 16/12/1967.}-- ou Glauber, novamente:
``tropicalismo é aceitação, ascensão do subdesenvolvimento''\footnote{\versal{ROCHA},
...
Candida, que vivia no exterior, no dia da morte de \versal{JK}, em agosto de
...
as aspas, e pense na letra da música (vou fazer um quadro).''\footnote{Ana
  ...
  Buarque e Armando Freitas Filho), Rio de Janeiro: \versal{IMS}, 1999, p. 222.}
...
os meios que lhe coubessem: a revolta, o protesto (\versal{OITICICA}, 2006,
p.164).
\end{quote}
...
lotavam as dependências do \versal{MAM} (\versal{CHAVES}, 2015, p.61).
\end{quote}
...
``participe'' enfim da sua época, de seu povo (\versal{OITICICA}, 2006, p.165).
\end{quote}
...
índia? italiana? (\versal{PEDROSA}, 1998, p.187-89).
\end{quote}
...
enorme acervo, de uma riqueza expressiva inigualável'' (\versal{OITICICA}, 2006,
...
suma o conformismo cultural, político, ético, social'' (\versal{OITICICA}, 2006,
...
chamados marginais (\versal{OITICICA}, 1996, p.25).
\end{quote}
...
levar o povo ao museu'' (\versal{CHAVES}, 2015, p.65). Este argumento, parece"-me,
...
aspirava'' (\versal{PEDROSA}; \versal{TOLEDO}, 2016, p. 32).
...
\versal{CHAVES}, Claudir. `Parangolé' impedido no \versal{MAM}. Diário Carioca, 14 ago.
1965. In: \versal{PERLINGEIRO}, Max. \emph{Opinião 65}: 50 anos depois. Rio de
...
\versal{OITICICA}, Hélio. Cara de Cavalo. In: \versal{BRETT}, Guy; \versal{FIGUEIREDO}, Luciano;
\versal{PAPE}, Lygia et al. \emph{Hélio Oiticica}. Rio de Janeiro: Centro de Arte
Hélio Oiticica, 1996, p. 25.

\_\_\_\_\_. Esquema Geral da Nova Objetividade. In: \versal{FERREIRA}, Glória;
...
1969/2016}. São Paulo: \versal{MASP}, 2016.

\versal{PEDROSA}, Mário. Um novo Di Cavalcanti. In: \versal{ARANTES}, Otília (org).
\emph{Acadêmicos e modernos}: textos escolhidos \versal{III}. São Paulo: Editora
da Universidade de São Paulo, 1998, p.187-190.

\_\_\_\_\_\_\_. Opinião\ldots{} Opinião\ldots{} Opinião. In: \versal{PERLINGEIRO}, Max.
...
ou \emph{Estou possuído}, chamava"-se um \emph{Parangolé} de \versal{HO}, que
...
\versal{CAMPOS}, Augusto. \emph{Balanço da Bossa}. São Paulo: Perspectiva, 2008,
p. 115.
...
\emph{Topoi} -- Revista de História (\versal{UFRJ}). n. 5. Rio de Janeiro:
dezembro de 2002.
...
\versal{SANTIAGO}, Silviano. ``Caetano enquanto superastro''. Em: \emph{Uma
literatura nos trópicos}: ensaios sobre dependência cultural. São Paulo:
Perspectiva\emph{,} 2000.

\versal{VELOSO}, Caetano. \emph{Verdade Tropical}. São Paulo: Cia das Letras,
2008.
...
impedem aprofundamento maior desse estudo? (\versal{RCB} 1, p. 3)
\end{quote}
...
dá gosto. (\versal{RCB}, 9-10, p. 338)
\end{quote}
...
nosso país foi o principal alento que tivemos. (\versal{RCB} 13, p. 3)
\end{quote}
...
eventos, citações, jargões e emblemas, resíduos, fragmentos.\footnote{Celso
  \versal{FAVARETTO}. \emph{Tropicália, alegoria, alegria.} Cotia: Ateliê, 2007;
...
era a primeira vez que eu o ouvia.\footnote{Caetano \versal{VELOSO}.
...
caminhadas pelo morro.\footnote{Hélio \versal{OITICICA}. \emph{Aspiro ao grande
...
levou inclusive à retirada das araras.\footnote{Mark \versal{BROWN}. ``Tate
...
sua ideia principal.''\footnote{\versal{OITICICA}. \emph{Aspiro ao grande
  labirinto}, p.109.} A proposta foi considerada uma ``estética do
envolvimento''.\footnote{Benedito \versal{NUNES}. \emph{Lygia Clark e Hélio
...
ideológicas no debate cultural em curso''\footnote{\versal{FAVARETTO}. \emph{A
...
julgamento.''\footnote{\versal{OITICICA}. ``O sentido de vanguarda do grupo
...
Sérgio Ferro e Waldemar Cordeiro (``realidade"-imagem'').\footnote{\versal{FAVARETTO}.
  \emph{A invenção de Hélio Oiticica}, p.158-161. Cf. Hélio \versal{OITICICA},
  ``Situação da vanguarda no Brasil'', em \emph{Aspiro ao grande
  labirinto}; Mario \versal{SCHEMBERG}, ``Um Novo Realismo'', em Dayse \versal{PECCININI}.
  \emph{Objeto na Arte: Brasil anos 60}. São Paulo: \versal{FAAP}, 1978; Waldemar
  \versal{CORDEIRO}, ``Realismo: musa da vingança e da tristeza'', em Dayse
  \versal{PECCININI}. \emph{Op. cit.}} O ponto crucial de distinção entre a
...
transformação, etc.''\footnote{\versal{OITICICA}. ``Esquema Geral da Nova
...
comportamento.''\footnote{\versal{FAVARETTO}. \emph{A invenção de Hélio
...
antropologia, da sociologia e da história.''\footnote{\versal{OITICICA}. ``Bases
...
existiu, o que existe é a invenção.''\footnote{\versal{OITICICA}. ``A arte
...
tornado dança''.\footnote{Idem, carta a Torquato, em \versal{TORQUATO} \versal{NETO}.
...
``característica primordial da dança''.\footnote{\versal{OITICICA}. ``Anotações
...
princípio de prazer.\footnote{\versal{OITICICA} \& Lygia \versal{CLARK}. \emph{Cartas
  1964-1974}; p.44.}
\end{quote}
...
Socialism''\footnote{É este o nome do primeiro capítulo em Herbert
  \versal{MARCUSE}. \emph{An Essay on Liberation}. Boston: Beacon Press, 1969.}.
...
Marcuse''.\footnote{Caetano \versal{VELOSO}, no facebook Caetano Veloso 13 de nov
...
esperança.''\footnote{\versal{MARCUSE}. Preface, \emph{An Essay on Liberation},
...
livres para interrompe"-los e prevenir seu recomeço.\footnote{\emph{Ibidem},
  ...
  \versal{NIETZSCHE}, em \emph{A Gaia Ciência}. Trad. Paulo César de Souza. São
...
própria sociedade.\footnote{\versal{MARCUSE}. Preface, \emph{An Essay on
  Liberation}, p.25.}
\end{quote}
...
revoluções, e de seus resultados inerentemente imprevisíveis''\footnote{Catherine
  \versal{DAWSON}. ``Maquinaria íntima: um exame marcuseano sobre a obra \emph{A
  casa é o corpo,} de Lygia Clark'', em revista \versal{ARTEFILOSOFIA}, n.18,
  2015, p.208.}.
...
ensaio.\footnote{\versal{MARCUSE}. Preface, \emph{An Essay on Liberation}, p.x.}
\end{quote}
...
\versal{ARTEFILOSOFIA}, n.18. Ouro Preto: \versal{UFOP}, 2015.

\versal{FAVARETTO}, Celso. \emph{A invenção de Hélio Oiticica}. São Paulo: Edusp,
2000.
...
\_\_\_\_\_\_\_\_\_ \& \versal{CARDOSO}, Ivan. ``A arte penetrável de Hélio
Oiticica'', entrevista a Ivan Cardoso, \emph{Folha de São Paulo},
16-11-1985.

\_\_\_\_\_\_\_\_\_ \& Lygia \versal{CLARK}. \emph{Cartas 1964-1974}. Rio de
Janeiro: \versal{UFRJ}, 1998.

\versal{PECCININI}, Dayse. \emph{Objeto na Arte: Brasil anos 60}. São Paulo:
\versal{FAAP}, 1978.

\versal{TORQUATO} \versal{NETO}. \emph{Os últimos dias de paupéria}. São Paulo: Max
Limonad, 1982.
...
\versal{ASSIS}, Machado de. Memórias Póstumas de Brás Cubas, disponível em
...
\versal{CAMPOS}, Fernando Coni. Cinema -- Sonho e Lucidez. Rio de Janeiro:
Azougue

Editorial, 2003. \versal{ISBN} 85-88338-34-3.
...
\chapter*{Brasil por multiplicação\footnote{Este título faz referência a
  ...
  Letras, \versal{SP}, 1987). Na verdade, além deste, outros dois ensaios desse
...
\begin{flushright}
\textbf{Luiz Camillo Osorio}\footnote{Professor na \versal{PUC}-Rio, pesquisador
...
abertura\footnote{Quem quiser ler uma discussão mais aprofundada deste
  ...
  Conccinitas}\ldots{}\ldots{}}. Só menciono este fato pois ele ocupou e tomou de
...
livro) aqui da \versal{PUC}, assim como deste diálogo com o \emph{Esquema Geral}
...
contemporânea (\ldots{})''\footnote{Oiticica, Hélio -- ``A transição da cor
...
antropofagia por meio de um \emph{glissando}\footnote{Sobre o modo como
  ...
  pensar, nr. 38, org. Pedro Durte, junho 2016, Rio de Janeiro"-\versal{PUC}) .}.
...
\begin{flushright}
Marília Rothier Cardoso\footnote{Departamento de Letras, \versal{PUC}-Rio}
\end{flushright}
...
foi encontrado em 1933 n`O rei da vela' de Oswald de Andrade. (\ldots{}) E `O
...
(\ldots{}) `O rei da vela' acabou virando manifesto para comunicarmos no
...
``\versal{PN}2 (1966) Pureza é um Mito'' e \versal{PN}3 (1966, 1967) Imagético''---a
...
alguns de seus objetos, no \versal{MAM}, integrando a exposição coletiva ``Á
...
\versal{ARAÚJO}, Emanoel et alii. \emph{Arthur Bispo do Rosário.} Org. e
...
\versal{ROCHA}, Glauber. \emph{Revolução do cinema novo.} São Paulo: Cosac Naify,
2004.
...
as guitarras e as roupas de plástico''.\footnote{Veloso, Caetano.
  ...
  \emph{Realidade}, ano \versal{III}, n. 33, dez. 1968, p. 197.} Produção
...
Tatit, parece que o século \versal{XX} foi ``O século da canção'', e que nesse
...
Chateaubriand\footnote{Chateaubriand começou a pensar em fazer televisão
  ...
  América Latina. \versal{CLARK}, Walter. 1988} colocou ``a coisa'' no ar, em
...
mostrando o desenrolar da vida (\versal{MOTA}, 2001).
...
cartesiano (\versal{ALMEIDA}, 2002:9). Maria Cândida chama atenção para o aspecto
...
\begin{quote}
\emph{\ldots{} a antropofagia, enquanto conceito, apresenta uma face
...
torna"-se discurso produtivo de identidades} (\versal{ALMEIDA}, 2002:4).
\end{quote}
...
próprias condições técnicas permitiam'' (\versal{CLARK}, 1988).
...
de televisão. O Jornal Nacional da \versal{TV} Globo estreia como primeiro
...
gigantesca gargalhada televisual.''(\versal{PIGNATARI}, 1984:13)
\end{quote}
...
aproximadamente 30 de suas emissões (\versal{MOTA}, 2001). Livre de
...
latinoamericanas en cultura y poder}. \versal{CLACSO}, Consejo Latinoamericano de
Ciencias Sociales, Caracas, Venezuela. 2002.

\versal{ALMEIDA}, Maria Cândida Ferreira. \emph{Só me interessa o que não é meu.}
A antropofagia de Oswald. 2002.
\emph{http://www.globalcult.org.ve/doc/CandidaRelea.doc.}

\versal{ALMEIDA}, Cândido; \versal{MACEDO}, Cláudia; \versal{FALCÃO}, Ângela (Org.). \emph{\versal{TV} ao
vivo}. Depoimentos. São Paulo: Brasiliense, 1988.

\versal{BARBOSA} \versal{LIMA}, Fernando; \versal{MACHADO}, Arlindo; \versal{PRIOLLI}, Gabriel.
\emph{Televisão e vídeo}. Rio de Janeiro: Zahar, 1985.

\versal{CLARK}, Walter; \versal{BARBOSA} \versal{LIMA}, Fernando. Um pouco de história e de
reflexão. In: \versal{ALMEIDA}, Cândido; \versal{MACEDO}, Cláudia; \versal{FALCÃO}, Ângela (Org.).
\emph{\versal{TV} ao vivo}. Depoimentos. São Paulo: Brasiliense, 1988.

\versal{MOTA}, Regina. \emph{A Épica Eletrônica de Glauber. Um estudo sobre
cinema e televisão}. Belo Horizonte: \versal{UFMG}, 2001.

\versal{PIGNATARI}, Décio. \emph{Signagem da Televisão}. São Paulo: Brasiliense,
1988.
...
Latino"-Americano''.\footnote{Tratam"-se, na verdade, de segmentos de um
  ...
  \versal{EDUSP}, 1995), 111, n. 44. Este texto, escrito em 1967 ---- um excerto
...
intensificar o consumo de massa.\footnote{\versal{PEDROSA}, Mário. \emph{Dos
...
movimentada cultura de massa.''\footnote{\versal{FERRO}, Sérgio.``\versal{IX} Bienal
...
tentativa de ``conquista da América''.\footnote{Sobre a investida de
  ...
  \versal{MA}: Museo Nacional Reina Sofia e \versal{MIT} Press, pp. 53-62.} Este fracasso
...
possível para se expressar.\footnote{\versal{GULLAR}, Ferreira.\emph{Vanguarda e
...
poeta atribuía ao formalismo modernista\footnote{\versal{GULLAR},
...
experiência do espaço na vida contemporânea.''\footnote{\versal{SALZSTEIN},
