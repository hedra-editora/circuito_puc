...
\chapter*{A mercadoria enternecida e os índios \emph{Limites~e~deslimites~do~tropicalismo~hoje}\footnote[*]{Este texto é uma parte de um ensaio maior,
  ...
  organizadores de cada evento: Frederico Coelho e Felipe Scovino (\versal{PUC"-RJ},
...
Os embates colocados por A mão do povo brasileiro
...
\begin{flushright}
\emph{Flávia Cêra (\versal{SPECIES})}
\end{flushright}
