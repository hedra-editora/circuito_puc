...
aceitação, ascenção do subdesenvolvimento''.\footnote{Glauber Rocha.
  ``Tropicalismo, antropologia, mito, ideograma 69''. In: \emph{Revolução do
...
os meios que lhe coubessem: a revolta, o protesto.\footnote{Hélio Oiticica. ``Esquema Geral da Nova Objetividade''. In: \emph{Escritos de artistas: anos 60/70}. Rio de Janeiro: Jorge
Zahar, 2006, p.~164.}
\end{quote}
...
lotavam as dependências do \versal{MAM}.\footnote{Claudir Chaves. ```Parangolé' impedido no \textsc{mam}''. In: \emph{Opinião 65: 50 anos depois}. Rio de Janeiro: Pinakotheke, 2015, p.~61.}
\end{quote}
...
levar o povo ao museu''.\footnote{Claudir Chaves. ```Parangolé' impedido no mam'', op.,~cit., p.~65.} Este argumento, parece"-me,
...
1969/2016}. São Paulo: \textsc{masp}, 2016, p.~32.}
...
\begin{Parskip}
\versal{CHAVES}, Claudir. ```Parangolé' impedido no \versal{MAM}''. Diário Carioca, 14/08/1965. In: \versal{PERLINGEIRO}, Max. \emph{Opinião 65: 50 anos depois}. Rio de
...
noites: o limite do desvario.\footnote{Hélio Oiticica, 1969.} %%Nao está nas referencias
\end{quote}
...
\versal{FICO}, Carlos. ```Prezada censura': cartas ao regime militar''. In:
...
\versal{VELOSO}, Caetano. \emph{Verdade Tropical}. São Paulo: Cia das Letras, 2008.
\end{Parskip}
...
esperança''.\footnote{Herbert Marcuse. ``Preface''. In: \emph{An Essay on Liberation},
...
própria sociedade.\footnote{Herbert Marcuse. ``Preface''. In: \emph{An Essay on
  Liberation}, p.~25.}
\end{quote}
...
ensaio.\footnote{Herbert Marcuse. ``Preface''. In: \emph{An Essay on Liberation}, p.~x.}
\end{quote}
...
\emph{The Guardian}, 20 Jun 2016, consultado em \textless{}\emph{www.theguardian.com}\textgreater{}.

\versal{DAWSON}, Catherine. ``Maquinaria íntima: um exame marcuseano sobre a obra
\emph{A casa é o corpo,} de Lygia Clark''. Tradução de Thiago Reis. In:
...
\_\_\_\_\_\_\_\_\_ \& \versal{CLARK}, Lygia. \emph{Cartas 1964-1974}. Rio de
...
nacional''.\footnote{José Celso Martinez Corrêa. In: Oswald de Andrade. \emph{O rei da vela}. São Paulo: Difusão Europeia do Livro, 1967, p.~45-6.} A descoberta da
...
{[}então{]}, tão distante do arrojo estético do cinema novo''.\footnote{José Celso Martinez Corrêa, op.~cit., p.~49.} De fato, quando o Oficina passou a
...
Com uma contundência comparável à do ``Manifesto Antropófago'',
...
quanto a ``indigência mental dos cineastas''.\footnote{Ibidem, p.~65.} Em tom exaltado,
...
violência''.\footnote{Ibidem, p.~65.}
...
atingir o que passou a considerar ``a invenção pura''.\footnote{Hélio Oiticica. In: Celso Favaretto. \emph{A invenção de Hélio Oiticica}. São Paulo: Ed\versal{USP/FAPESP}, 2000, p.~47.}
...
Resultante da combinação de dois ``penetráveis'' --
...
``materiais existentes na Terra para o uso do homem''.\footnote{Bispo do Rosário. In: Campos (org.), 2016, p.~188.} Lacônico e enigmático, o %Não está nas referêbncias
escolhido anuncia ``Eu vim''.\footnote{Herkenhoff. In: Emanoel Araújo et at. \emph{Arthur Bispo do Rosário}. Rio de Janeiro: Réptil, 2012, p.~141.}
...
``o sub desenvolvido embaixo da terra como rato de si mesmo'',\footnote{Hélio Oiticica.
  ``Subterrânia''. In: César Oiticica Filho (org.), op.~cit., p. 145.} não há nessa caracterização uma conotação puramente
...
merda'' para construir outra possibilidade de Brasil.\footnote{Hélio Oiticica.
  ``Brasil diarreia''. In: César Oiticica Filho (org.), op.~cit., p. 163.} Uma construção subterrânea que talvez fosse, parece
...
mostrando o desenrolar da vida.\footnote{Regina Mota. \emph{A Épica Eletrônica de Glauber. Um estudo sobre cinema e televisão}. Belo Horizonte: ufmg, 2001.}
...
próprias condições técnicas permitiam''.\footnote{Walter Clark; Fernando Barbosa Lima. ``Um pouco de história e de reflexão''. In: \emph{\textsc{tv} ao vivo. Depoimentos}. São Paulo: Brasiliense, 1988.}
...
novo e a aventura da criação'', 68{]} %%%O QUE SAO OS COLCHETES?
...
histérica''.\footnote{Glauber Rocha. ``Revolução Cinematográfica'', op.~cit., p.~100.}
