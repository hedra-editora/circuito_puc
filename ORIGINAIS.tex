...
merda'' para construir outra possibilidade de Brasil.\footnote{Hélio Oiticica.
  ``Brasil diarreia'', op.~cit., p.~163.} Uma construção subterrânea que talvez fosse, parece
...
\begin{Parskip}
\textsc{cardoso}, Fernando Henrique \& \textsc{faletto}. \emph{Dependência e desenvolvimento na América Latina: ensaio de interpretação sociológica.} Rio de Janeiro: Zahar, 1970.
