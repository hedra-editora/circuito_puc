...
\versal{CAMPOS}, Haroldo de. \emph{Qohélet = o"-que"-sabe: Eclesiastes: poema sapiencial}. Disponível em: \textless{}\emph{https://bit.ly/2KyY8fb}\textgreater{}.
...
\versal{VIVEIROS DE CASTRO}, Eduardo. ``Immanence and fear: Stranger-events and subjects in Amazonia''. \emph{\versal{HAU}: Journal of Ethnographic Theory} 2 (1).
...
\begin{flushright}
\emph{Diego Viana (\versal{USP} -- Paris 7)}
\end{flushright}
...
\begin{flushright}
\emph{Eduardo Jardim (\versal{PUC-RIO})}
\end{flushright}
...
\begin{flushright}
\emph{Felipe Scovino (\versal{UFRJ})}
\end{flushright}
...
\versal{MANUEL}, Antonio. \emph{Antonio Manuel}. Rio de Janeiro: Funarte, 1985.
...
\versal{PAPE}, Lygia. ``Favela da Maré ou Milagre das Palafitas''. In: \versal{BORJAS"-VILLEL}, Manuel; \versal{VELÁZQUEZ}, Teresa. \emph{Lygia Pape: espaço imantado}. São Paulo: Pinacoteca do Estado, 2012, p.~287-89.

\_\_\_\_\_\_. \emph{Lygia Pape: entrevista a Lúcia Carneiro e Ilena Pradilla}. Rio de Janeiro: Nova Aguilar, 1998.
...
\begin{flushright}
\emph{Flávia Cêra (\versal{SPECIES/UFPR})}
\end{flushright}
...
\begin{flushright}
\emph{Frederico Coelho (\versal{PUC-RIO})}
\end{flushright}
...
\begin{flushright}
\emph{Imaculada Kangussu (\versal{UFOP})}
\end{flushright}
...
\begin{flushright}
\emph{Luiz Camillo Osorio (\versal{PUC-RIO})}
...
Schwarz realizada no dia da abertura.\footnote{Quem quiser ler uma discussão mais aprofundada deste
...
\begin{flushright}
\emph{Marcia Sá Cavalcante Schuback\\(Universidade de Södertörn)}
\end{flushright}
...
\begin{flushright}
\emph{Marília Rothier Cardoso (\versal{PUC-RIO})} 
\end{flushright}
...
\begin{flushright}
\emph{Moacir dos Anjos\\(Fundação Joaquim Nabuco)}
\end{flushright}
...
\begin{flushright}
\emph{Paulo da Costa e Silva (\versal{UFRJ})}
\end{flushright}
...
\begin{flushright}
\emph{Pedro Duarte (\versal{PUC-RIO})}
\end{flushright}
...
\begin{Parskip}
\versal{AVELLAR}, Idelbe. \emph{Alegorias da derrota: a ficção pós-ditatorial e o trabalho de luto na América Latina}. Belo Horizonte: Ed. \versal{UFMG}, 2003.

\versal{BASUALDO}, Carlos (org.). \emph{Tropicália: uma revolução na cultura brasileira}. São Paulo: Cosac Naify, 2007. 

\versal{COHN}, Sergio \& \versal{COELHO}, Frederico (orgs.). \emph{Tropicália}. Rio de Janeiro: Azougue, 2008.
 
\versal{FOUCAULT}, Michel. \emph{Microfísica do poder}. Rio de Janeiro: Graal, 1979. 

\versal{GAGNEBIN}, Jeanne Marie. \emph{História e narração em Walter Benjamin}. São Paulo: Perspectiva, 1999.

\versal{HOLLANDA}, Heloisa Buarque de. \emph{Impressões de viagem: \textsc{cpc}, vanguarda e desbunde: 1960/70}. São Paulo: Brasiliense, 1980. 

\versal{KONDER}, Leandro. ``A rebeldia, os intelectuais e a juventude''. Revista Civilização Brasileira, n.~15, set.~1967, p.~135-45. 

\versal{LOPES}, Paulo Eduardo. \emph{A desinvenção do som: leituras dialógicas do tropicalismo}. Campinas: Pontes, 1999. 

\versal{MARCUSE}, Herbert. \emph{Eros e civilização}. Rio de Janeiro: Zahar: 1968. 

\versal{MARX}, Karl. \emph{A ideologia alemã}. São Paulo: Boitempo, 2007.

\versal{REIS}, Daniel Aarão. \emph{Ditadura e democracia no Brasil}. Rio de Janeiro: Zahar, 2014.

\versal{RIDENTI}, Marcelo. \emph{O fantasma da revolução brasileira}. São Paulo: Unesp, 2005.

\versal{VELOSO}, Caetano. \emph{Verdade tropical}. São Paulo: Companhia das Letras, 1997.
...
\begin{flushright}
\emph{Rodrigo Nunes (\versal{PUC-RIO})}
\end{flushright}
...
\begin{flushright}
\emph{Sérgio Bruno Martins (\versal{PUC-RIO})}
\end{flushright}
